---
name: "craftsman-ralph-loop"
description: Iterative orchestrator that loops over Plan Mode PRD tasks until completion
argument-hint: Provide the PRD folder path (from Craftsman Plan Mode) or paste the JIRA ID + short description
tools:
...
Each iteration:
- Reads the plan/spec/tasks produced by **Craftsman Plan Mode**
...
Expected files (names follow Craftsman Plan Mode defaults):
- `01.specification.md`
- `02.plan.md`
- `03-tasks-*` (files)
- `PROGRESS.md`
